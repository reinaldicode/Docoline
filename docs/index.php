                        ...
                        <ul class="dropdown-menu">
                            ...
                            if (file_exists($jsonFile)) {
                                ...
                                if (is_array($docTypes) && count($docTypes) > 0) {
                                        ...
                                        if ($hasSubmenu && count($submenu) > 0) {
                                            ...
                                            foreach ($submenu as $sub) {
                                                ...
                                                if (!empty($subLegacyFile)) {
                                                    // Legacy: Link ke file custom (tidak perlu cek file_exists, biarkan server handle)
                                                    $url = $subLegacyFile;
                                                } else {
                                                    // Modern: Link ke documents.php (ini yang perlu login)
                                    ...
                                    // Fallback jika JSON kosong - langsung ke file legacy
                                ...
                                // Fallback jika file tidak ada - langsung ke file legacy
                                echo '<li><a href="dokawal.php">All Documents</a></li>';
                                echo '<li role="separator" class="divider"></li>';
                                echo '<li><a href="procedure_awal.php">Procedure</a></li>';
                                echo '<li><a href="wi_awal.php">WI</a></li>';
